  ...
  return (
    <>
      <div className="impressum">
        ...
        <p>
          Die Gewerbeanmeldung nach &sect; 34c GewO wurde am 01.01.2001 durch
          Ordnungsamt Musterstadt erteilt.
        </p>

        <h2>Aufsichtsbeh&ouml;rde</h2>
        <p>
          Musterbeh&ouml;rde Musterstadt
          <br />
          Musterweg 10
          <br />
          90210 Musterstadt
        ...
        <p>
          Dieses <a href="http://www.jurarat.de/muster-impressum">Impressum</a>{" "}
